...
const DEBOUNCE_IMAGES_DELAY = 500;
...
export { PHOTOS_MIN, PHOTOS_RANDOM, PHOTOS_MAX, LIKES_MIN, LIKES_MAX, COMMENTS_MIN, COMMENTS_VISIBLE, COMMENTS_MAX, COMMENTS_LENGTH_MAX, AVATAR_MIN, AVATAR_MAX, DESCRIPTIONS, MESSAGES, NAMES, MAX_HASHTAGS, SCALE_DEFAULT, SCALE_MIN, SCALE_STEP, SCALE_MAX, SLIDER_INITIAL_MIN, SLIDER_INITIAL_STEP, SLIDER_INITIAL_MAX, SLIDER_MARVIN_MAX, SLIDER_MARVIN_STEP, SLIDER_PHOBOS_MAX, SLIDER_HEAT_MIN, SLIDER_HEAT_MAX, ALERT_SHOW_TIME, BASE_URL, DEBOUNCE_IMAGES_DELAY, FILE_TYPES };
